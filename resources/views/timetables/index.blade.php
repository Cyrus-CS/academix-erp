...
<div class="space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2 flex-wrap self-start sm:self-auto">
            ...
            {{-- Imprimer --}}
            @if($selectedClass)
            <a href="{{ route('timetables.print', ['class_id' => $selectedClass->id]) }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium
            ...
            @else
            <button disabled title="Sélectionnez une classe pour imprimer" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium
                   border border-slate-200 dark:border-slate-700
